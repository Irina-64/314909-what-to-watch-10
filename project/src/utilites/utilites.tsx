...
import FilmTabDetails from '../components/movies/movie-tabs/tab-details/tab-details';
import FilmTabOverview from '../components/movies/movie-tabs/tab-overview/tab-overview';
import FilmTabReviews from '../components/movies/movie-tabs/tab-reviews/tab-reviews';
...
export const getRatingName = (rating: number) => {
  switch (true) {
    case rating === RatingValue.NoReviews:
