...
const {mockCurrentFilm, mockHistory, wrapper, mockVideoAPI} = testUtils();

beforeAll(mockVideoAPI);

describe('Application Routing', () => {
  it('should render "AddReviewPage" when user navigate to "/movies/:id/review"', () => {
    mockHistory.push(`${AppRoute.Films}${mockCurrentFilm.id}/review`);
  ...
  it('should render "MoviePage" when user navigates to "/movie/:id"', () => {
    mockHistory.push(`${AppRoute.Films}${mockCurrentFilm.id}`);
  ...
  it('should render "MoviePlayerPage" when user navigate to "/player/:id"', () => {
    mockHistory.push(`${AppRoute.Player}${mockCurrentFilm.id}`);
